    ...
    <div class="bg-white shadow-md rounded-lg p-4">
        ...
        <form class="mt-6" method="POST" enctype="multipart/form-data" >
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="{{Auth::user()->name}}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-200 focus-border-blue-300 bg-gray-200 p-2">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="file" id="profileImage" name=" image" accept="image/*"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus ring focus:ring-200 focus-border-blue-300 bg-gray-200 p-2">
                <div id="imagePreview" class="w-20 h-20 mt-2 rounded-full border border-gray-300 overflow-hidden">
                    <img id="selectedImage" src="" alt="Selected Image" class="w-full h-full object-cover">
